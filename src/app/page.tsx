...
export default function Dashboard() {
  ...
  return (
    <main className="min-h-screen p-6 md:p-10 max-w-6xl mx-auto">
      ...
      <div className="mb-4 flex items-center justify-between"><h2 className="text-lg font-bold">Apps & Features</h2><span className="text-xs font-mono text-[#5b7a99]">MULTICHAIN READY</span></div>
