  ...
  return (
    <main className="min-h-screen p-6 md:p-10 max-w-6xl mx-auto">
      ...
      <div className="bg-gradient-to-br from-[#0d1f35] to-[#0a1525] border border-[#63caff33] rounded-2xl p-8 mb-8 relative overflow-hidden">
        ...
        <p className="text-[#00ffa3] text-sm mt-2 font-mono">Arc · Ethereum · Base · Polygon · Arbitrum · OP · BNB · Avalanche</p>
      ...
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-lg font-bold">Apps & Features</h2>
        <span className="text-xs font-mono text-[#5b7a99]">MULTICHAIN READY</span>
      </div>
