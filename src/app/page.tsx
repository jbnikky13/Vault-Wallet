...
const features = [
  ...
  { name: "Swap", path: "/swap", icon: "⇅", desc: "Token swap on Arc", badge: "x402", color: "#63caff" },
  ...
  { name: "NFT Marketplace", path: "/nft", icon: "◆", desc: "Buy, sell & list NFTs", badge: "x402", color: "#a78bfa" },
];
    ...
    <main className="min-h-screen p-6 md:p-10 max-w-6xl mx-auto">
      <div className="flex justify-between items-start mb-10 gap-6">
        <div>
          ...
          <p className="text-[#5b7a99] text-sm mt-1 font-mono">Circle Arc Network · Agent Stack · Gateway · x402</p>
        </div>
        <ConnectButton />
      </div>
      ...
      <div className="bg-gradient-to-br from-[#0d1f35] to-[#0a1525] border border-[#63caff33] rounded-2xl p-8 mb-8 relative overflow-hidden">
        ...
        <p className="text-4xl md:text-5xl font-black tracking-tight bg-gradient-to-r from-white to-[#63caff] bg-clip-text text-transparent">Arc Testnet</p>
        <p className="text-[#00ffa3] text-sm mt-2 font-mono">Chain ID 5042002 · USDC-native fees · sub-second finality</p>
